...
public class StoryContentActivity extends BaseActivity<StoryContentPresenter> implements StoryContentContract.View {

    @BindView(R.id.image)ImageView image;
    @BindView(R.id.title)TextView title;
    @BindView(R.id.image_source)TextView image_source;
    ...
    @Override
    protected StoryContentPresenter loadPresenter() {
        return new StoryContentPresenter();
    }
    ...
    public void getStoryContent(StoryContentBean bean) {
        ...
        image_source.setText(bean.getImage_source());
